...
export function SiteFooter() {
  ...
  return (
    <footer className="relative border-t border-white/10 bg-[#08191d]">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_top,rgba(38,132,145,0.2),transparent_55%)]" />
        ...
        <div className="grid gap-12 md:grid-cols-[2fr,3fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-md text-sm text-white/70">
              Practical cybersecurity guidance for people and teams, built around real incidents and verified public sources.
            </p>
            <Link
              href="/get-help"
